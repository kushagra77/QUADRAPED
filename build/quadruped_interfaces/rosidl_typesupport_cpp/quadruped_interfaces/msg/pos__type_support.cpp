...
static const _Pos_type_support_symbol_names_t _Pos_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, quadruped_interfaces, msg, Pos)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, quadruped_interfaces, msg, Pos)),
  }
};
...
{
  return &::quadruped_interfaces::msg::rosidl_typesupport_cpp::Pos_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, quadruped_interfaces, msg, Pos)() {
  return get_message_type_support_handle<quadruped_interfaces::msg::Pos>();
}
