...
static const _Pos_type_support_symbol_names_t _Pos_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, quadruped_interfaces, msg, Pos)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, quadruped_interfaces, msg, Pos)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, quadruped_interfaces, msg, Pos)() {
  return &::quadruped_interfaces::msg::rosidl_typesupport_c::Pos_message_type_support_handle;
}
